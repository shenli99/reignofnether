    ...
    public static Button getStartButton(ProductionBuilding prodBuilding, Keybinding hotkey) {
        return new Button(
            ...
            List.of(
                ...
                FormattedCharSequence.forward(Component.translatable("unit.villagers.villagerprod.description1").getString(), Style.EMPTY),
                FormattedCharSequence.forward(Component.translatable("unit.villagers.villagerprod.description2").getString(), Style.EMPTY)
            )
        );
    }
